...
const onStart = (req, res) => {
    try {
        ...
        INSERT INTO users(name,email)VALUES('Test Student','ssupport@student.neumont.edu');
        INSERT INTO tickets("userName","title",email,loaner,comments)VALUES('Test Student','Test','ssupport@student.neumont.edu','XXXXX','This is a test of the system')`, (err, result) => {
            if (err) {
                console.log(err);
            }
